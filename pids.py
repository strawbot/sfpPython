# PID declarations  generated by parsepids.py  Aug 21, 2018  16:46:56
...
BEACON=0xf	# used to announce presence - such as over IP/UDP
MAX_PIDS=0x10	# number of PIDS defined
...
pids = {
	...
	BEACON:"BEACON",	# used to announce presence - such as over IP/UDP
...
NUM_LINKS=3	# number of links per node
...
UDP_HOST=0x4	# host side through IP
ROUTING_POINTS=0x5	# number of points for routing
